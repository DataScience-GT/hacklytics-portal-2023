...
export default function ScavengerHuntCheckinUpdateForm(props) {
  const {
    id: idProp,
    scavengerHuntCheckin: scavengerHuntCheckinModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [scavengerHuntCheckinRecord, setScavengerHuntCheckinRecord] =
    React.useState(scavengerHuntCheckinModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(ScavengerHuntCheckin, idProp)
        : scavengerHuntCheckinModelProp;
      setScavengerHuntCheckinRecord(record);
    };
    queryData();
  }, [idProp, scavengerHuntCheckinModelProp]);
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || scavengerHuntCheckinModelProp)}
