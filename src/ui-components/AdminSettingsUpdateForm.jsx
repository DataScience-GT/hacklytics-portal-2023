...
export default function AdminSettingsUpdateForm(props) {
  const {
    id: idProp,
    adminSettings: adminSettingsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [adminSettingsRecord, setAdminSettingsRecord] = React.useState(
    adminSettingsModelProp
  );
  React.useEffect(() => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || adminSettingsModelProp)}
