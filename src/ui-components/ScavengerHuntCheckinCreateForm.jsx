...
export default function ScavengerHuntCheckinCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setCheckpointID(initialValues.checkpointID);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ScavengerHuntCheckin(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ScavengerHuntCheckinCreateForm")}
      {...rest}
    >
      <TextField
        label="Checkpoint id"
