...
export default function EditScavengerHunt(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = scavengerHuntRecord
      ? { ...initialValues, ...scavengerHuntRecord }
      : initialValues;
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            ScavengerHunt.copyOf(scavengerHuntRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "EditScavengerHunt")}
      {...rest}
    >
      <Heading
        children="Edit Scavenger Hunt Checkpoint"
