    ...
    return (
        <div className={styles.TracksPage}>
            ...
            <View width={"85%"}>
                ...
                >
                <TabItem title="Sports" width="10em" className={styles.TabItem}>
                ...
                <TabItem title="Healthcare" width="10em" className={styles.TabItem}>
                ...
                <TabItem title="Gen AI" width="10em" className={styles.TabItem}>
                ...
                <TabItem title="Finance" width="10em" className={styles.TabItem}>
