...
export default function CreateScavengerHunt(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ScavengerHunt(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CreateScavengerHunt")}
      {...rest}
    >
      <Heading
        children="Create Scavenger Hunt Checkpoint"
